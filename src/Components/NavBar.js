...
const CustomLink = ({ href, title, className = "" }) => {
    ...
    console.log(router)
    return (
        <Link href={href} className={`${className} relative mr-4 group`}>
        {title}
        <span
          className={`
...
const CustomMobileLink = ({ href, title, className = "",toggle }) => {
    ...
    return (
        <button href={href} className={`${className} relative mr-4 group text-light dark:text-dark my-2`} onClick={handleClick}>
        {title}
        <span
          className={`
  ...
  return (
      <header 
          ...
          <nav className='flex items-center justify-center flex-wrap'>
              <motion.a href="https://twitter.com/AjmalHusain_" target={"_blank"}
                  whileHover={{ y: -2 }}
                  whileTap={{scale:0.9}}
                  className='w-6 mr-3'
              >
              ...
              <motion.a href="https://www.linkedin.com/in/ajmal-husain-1231341a2/" target={"_blank"}
                  whileHover={{ y: -2 }}
                  whileTap={{scale:0.9}}
               className='w-6 mx-3'>
                  <LinkedInIcon />
              </motion.a>
              <motion.a href="https://github.com/OriginalAjmal" target={"_blank"}
                  whileHover={{ y: -2 }}
                  whileTap={{scale:0.9}}
               className='w-6 ml-3'>
                  <GithubIcon />
